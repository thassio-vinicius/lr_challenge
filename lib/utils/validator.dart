...
class TextFieldValidators {
  ...
  final StringValidator displayNameSubmitValidator = MinLengthStringValidator(2);
  final StringValidator confirmPasswordSubmitValidator = NonEmptyStringValidator();
  final StringValidator descriptionSubmitValidator = AlwaysValidStringValidator();
  final StringValidator ageRestrictionSubmitValidator = AlwaysValidStringValidator();
