class Strings {
  static const String reNest = 'ReNest';
  static const String noTasks = 'No tasks for now.\n Try adding one by tapping \'+\'.';
  ...
  static const String acceptConfirm = 'I accept the';
  ...
  static const String passwordResetFailed = "There was an error with your password recovery";
  static const String signInFailed = "Log in error";
  static const String sendResetLink = "Send reset link";
  static const String invalidConfirmPasswordEmpty = "Confirm Password can't be empty";
  static const String invalidPasswordsNoMatch = "Password and Confirm Password don't match";
  ...
  static const String acceptPrivacyTermsFirst = "You must accept our Privacy Policy and Terms & Conditions first";

  static List<String> taskTitles = [
